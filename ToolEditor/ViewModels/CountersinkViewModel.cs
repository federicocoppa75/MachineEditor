...
{
    public class CountersinkViewModel : ToolViewModel<CountersinkTool>
    {
        ...
        public double Length3
        {
            ...
            set
            {
                if (Set(ref _length3, value, nameof(Length3)))
                {
                    UpdateModel();
                    RaisePropertyChanged(nameof(TotalLength));
                }
        ...
        protected override ToolType ToolType => ToolType.Countersink;

        public CountersinkViewModel() : base()
        {

        }

        protected override void UpdateModel(CountersinkTool tool)
        {
            tool.Diameter1 = Diameter1;
            tool.Diameter2 = Diameter2;
            tool.Length1 = Length1;
            tool.Length2 = Length2;
            tool.Length3 = Length3;
